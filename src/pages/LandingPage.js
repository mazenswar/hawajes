...
const landingParagraphOne =
  'عقيل خليل إبراهيم آل سوار ، مصورٌ، وكاتبٌ صحفي وأدبي من مواليد المنامة سنة ١٩٤٥، متزوج وله ابنتين وولد، وحفيدتان.\n\nبدأ حياته العملية موظفًا في قسم التموين في شركة طيران الخليج، ولكنه باكتشافه شغفه بالتصوير الفوتوغرافي أنشأ مؤسسة "بنسوار" للتصوير، كما كان المصور الرسمي لشركة طيران الخليج وفندق الخليج في العام ١٩٧٠. قاده شغفه بالتصوير إلى عالم الصحافة، فبدأ مشواره صحفيًا في مجلة صدى الأسبوع (الأسبوعية) من العام ١٩٧٣ وحتى ١٩٧٧، ليعود إليها في ١٩٨٢ مديرًا للتحرير.';

const landingParagraphTwo =
  'في عام ١٩٨٣ ساهم في تأسيس وإدارة تحرير مجلة بانوراما الخليج (الشهرية) مع الأستاذ إبراهيم بشمي. وبين عامي ١٩٨٦ و١٩٩٦ بدأ بكتابة عمودٍ يومي في جريدة أخبار الخليج بعنوان "هواجس"، وانتقل بعموده اليومي في العام ١٩٩٧ إلى جريدة الأيام، واستمر في كتابته حتى العام ٢٠٠٥. في العام ٢٠٠٥ باشر العمل في جريدة الوطن مقدمًا ورشًا تدريبية للصحفيين، قبل أن يعاود كتابة عموده اليومي "هواجس" حتى تقاعده في ٢٠١٢.';
